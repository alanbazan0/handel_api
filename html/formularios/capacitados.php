	...
	<div class="modal-dialog modal-lg" role="document"> 
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="scrollmodalLabel">Capacitado</h5>
...
<!-- 					</div> -->
					...
					<div class="form-group">
						<div>
							...
							<input id="nombreInput" name="nombreInput" type="text" class="form-control" onkeyup="vista.cambiarNombre();">
						</div>
					</div>
					<div class="form-group">
						<div>
							<label for="apellidoInput" class="control-label mb-1">Apellido</label>
							<input id="apellidoInput" name="apellidoInput" type="text" class="form-control" onkeyup="vista.cambiarNombre();">
						</div>
					</div>
