  ...
  <div class='modal-dialog modal-lg' role='document'> 
      <div class='modal-content'>
          <div class='modal-header'>
              <h5 class='modal-title' id='scrollmodalLabel'>Asignar formato a usuario</h5>
          ...
          <div class='modal-body'>
              <form id='formulario' action='#'  method='post'>
                  ...
                  <div class='form-group'>
                    ...
                    <hr style='border-top: 1px solid #3c8dbc;'>
                   <label class="control-label text-primary" style='text-align:center'><i class="fa fa-file-text-o"></i> FORMATO</label>
                 <!--  <div class='form-group'>
                      <div>
                          <label class='control-label mb-1'>Sede</label>
                    ...
                    <div class='form-group'>
                      <div>
                          <label class='control-label mb-1'>Formato</label>
