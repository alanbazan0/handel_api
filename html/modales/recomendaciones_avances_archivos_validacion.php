			...
			<div class="modal-body">
				...
				<div class="box-body row"  >
					<form id="formulario" action="#"  method="post" class='col-lg-6 col-md-6 col-xs-12'>
    					...
    					<div class="form-group">
    						<div>
    							<label id="usuarioComentarioLabel" class="control-label mb-1"></label>
    							<br>
    							<span id="comentarioLabel" class="control-label mb-1"></span>
    						</div>
    					</div>
    					<div class="form-group">
    						<div>
					...
					<div class='col-lg-6 col-md-6 col-xs-12'>
    					<div class="form-group">
        						<div>
        							...
        							<button id="pendienteRecomendacionArchivosButton" style='display:none' class='btn btn-warning float-right'><i class=''></i> Pendiente</button>
