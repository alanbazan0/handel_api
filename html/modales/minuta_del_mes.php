	...
	<div class="modal-dialog" role="document"> 
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="scrollmodalLabel">Minuta del mes</h5>
				...
				<div class="box-body" >
					<form id='reporteFormulario'>
    					...
    					<div class="form-group">
    						...
    						<div>
    							<label for="administradorSelectReporte" class="control-label mb-1">Administrador</label>
    							<select name="administradorSelectReporte" id="administradorSelectReporte"  class="form-control campo" ></select>
    						</div>
    					</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
 				<button id="imprimirButton" type="submit" class="btn btn-primary" >Generar texto</button> 
			</div>
		</div>
	</div>
</div>