...
{	
	...
	consultarAuditoriasSociosComerciales(contexto,funcion)
	{				
		var url = HANDEL_API + "/" + this.servicio;
		 $.ajax({
          url: url,
          type: 'POST',
          data: {accion : "consultarAuditoriasSociosComerciales"},
          success: function( data, textStatus, jQxhr )
          {
              funcion.call(contexto,data);
          },
	...
	enviarNotificacionCliente(contexto,funcion,auditoriaId)
	{		
		var url = HANDEL_API + "/" + this.servicio;
		   $.ajax({
	       url: url,
	       type: 'POST',
	       data: {accion : "enviarNotificacionCliente", auditoriaId: auditoriaId},
	       success: function( data, textStatus, jQxhr )
	       {
	           funcion.call(contexto,data);
	       },
