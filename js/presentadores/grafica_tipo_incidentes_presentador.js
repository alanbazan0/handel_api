class GraficaTipoIncidentesPresentador extends CatalogoPresentador
{
	 constructor(vista)
	 {
	 ...
	 consultar()
	 {
		 ...
		 this._repositorio.consultarTipoIncidentes(this,this.consultarResultado,this.vista.criteriosSeleccion);
	 }
