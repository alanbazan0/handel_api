class GraficaTiempoPromedioInspeccionInspectorPresentador extends CatalogoPresentador
{
	 constructor(vista)
	 {
	 ...
	 consultar()
	 {
		 ...
		 this._repositorio.consultarTiempoPromedioInspeccionInspector(this,this.consultarResultado,this.vista.criteriosSeleccion);
	 }
