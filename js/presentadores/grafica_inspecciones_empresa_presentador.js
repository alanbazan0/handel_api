class GraficaInspeccionesEmpresaPresentador extends CatalogoPresentador
{
	 constructor(vista)
	 {
	 ...
	 consultar()
	 {
		 ...
		 this._repositorio.consultarInspeccionesEmpresa(this,this.consultarResultado,this.vista.criteriosSeleccion);
	 }
