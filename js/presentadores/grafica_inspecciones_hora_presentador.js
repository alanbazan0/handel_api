class GraficaInspeccionesHoraPresentador extends CatalogoPresentador
{
	 constructor(vista)
	 {
	 ...
	 consultar()
	 {
		 ...
		 this._repositorio.consultarInspeccionesHora(this,this.consultarResultado,this.vista.criteriosSeleccion);
	 }
