class GraficaInspeccionesSedePresentador extends CatalogoPresentador
{
	 constructor(vista)
	 {
	 ...
	 consultar()
	 {
		 ...
		 this._repositorio.consultarInspeccionesSede(this,this.consultarResultado,this.vista.criteriosSeleccion);
	 }
