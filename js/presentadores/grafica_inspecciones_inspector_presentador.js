class GraficaInspeccionesInspectorPresentador extends CatalogoPresentador
{
	 constructor(vista)
	 {
	 ...
	 consultar()
	 {
		 ...
		 this._repositorio.consultarInspeccionesInspector(this,this.consultarResultado,this.vista.criteriosSeleccion);
	 }
