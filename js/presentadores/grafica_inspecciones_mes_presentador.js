class GraficaInspeccionesMesPresentador extends CatalogoPresentador
{
	 constructor(vista)
	 {
	 ...
	 consultar()
	 {
		 ...
		 this._repositorio.consultarInspeccionesMes(this,this.consultarResultado,this.vista.criteriosSeleccion);
	 }
	 ...
	 consultarAnoCriterio()	
	 {
		 var repositorio = new InspeccionesRepositorio(this);		
		 repositorio.consultarAnos(this,this.consultarAnoCriterioResultado,null,true);
	 }
	 
	 consultarAnoCriterioResultado(resultado)
	 {
		if(resultado.mensajeError=="")
		{
			this.vista.anosCriterio = resultado.valor;
		}
		else
			this.vista.mostrarMensajeError("Error",resultado.mensajeError);
