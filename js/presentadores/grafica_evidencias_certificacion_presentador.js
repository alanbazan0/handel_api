class GraficaEvidenciasCertificacionPresentador extends CatalogoPresentador
{
	 constructor(vista)
	 {
	 ...
	 consultar()
	 {
		 ...
		 this._repositorio.consultarPorcentajesCertificaciones(this,function(resultado)
		 {
