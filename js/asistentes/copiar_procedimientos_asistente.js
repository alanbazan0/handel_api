class CopiarProcedimientosAsistente
{
	constructor()
	{
		var date = new Date();
...
//		this._iconosModal = new IconosModal();
	...
	consultarProcedimientos()
	{
		...
		repositorio.consultarPorEmpresaSede(this,this.consultarProcedimientosResultado,empresaId, sedeId);
	}
	...
	consultarProcedimientosResultado(resultado)
	{
		...
		{
			this.procedimientos = resultado.valor;
		}
		else
