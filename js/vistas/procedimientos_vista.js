class ProcedimientosVista extends CatalogoVista
{		
	constructor(ventana)
	{	
		super(ventana);
		this.presentador = new ProcedimientosPresentador(this);
		this._urlFormulario = "html/formularios/procedimientos.php";
	}
...
var vista = new ProcedimientosVista(this);
