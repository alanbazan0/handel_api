class PerfilesVista extends CatalogoVista
{		
	constructor()
	{	
		super();
		this.presentador = new PerfilesPresentador(this);
		this._urlFormulario = "html/formularios/perfiles.php";
	}
...
var vista = new PerfilesVista(this);
