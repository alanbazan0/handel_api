class JustificacionesVista extends CatalogoVista
{		
	constructor()
	{	
		super();
		this.presentador = new JustificacionesPresentador(this);
		this._urlFormulario = "html/formularios/justificaciones.php";
	}
...
var vista = new JustificacionesVista(this);
