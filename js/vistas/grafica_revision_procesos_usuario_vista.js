class GraficaRevisionProcesosUsuarioVista extends CatalogoVista
{		
	constructor()
	{	
		super();
		this.presentador = new GraficaRevisionProcesosUsuarioPresentador(this);
	}
	...
	set porcentajesUsuarios(porcentajesAreas)
	{
		am4core.ready(function() {
			...
			RevisionProcesosSeries.crear(chart,"nombreId","nombreCompleto");
...
var vista = new GraficaRevisionProcesosUsuarioVista(this);	
