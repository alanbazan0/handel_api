...
//		this._tarjetas.plantillaHtml =  `<div class="media">
//											<div class="media-left">
//											<a href="#"><img alt="" src=" ` + HANDEL_API +  `/php/portadas_cursos/{{portada}}" style='width:80px;height:80px;  border-radius:  20%;'></a>
//										</div>
//								
//								
//										
...
//					                          <li><a href="#" class='text-red'>Eliminar</a></li>
//					                        </ul>
//					                      </div>
//								
//								
