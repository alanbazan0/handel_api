class GraficaCapacitacionesAvanceSedeVista extends CatalogoVista
{		
	constructor(ventana)
	{	
		super(ventana);
		this.presentador = new GraficaCapacitacionesAvanceSedePresentador(this);
...
var vista = new GraficaCapacitacionesAvanceSedeVista(this);
