class UsuariosFormatosVista extends CatalogoVista
{		
	constructor(ventana)
	{	
		super(ventana);
		this.presentador = new UsuariosFormatosPresentador(this);
		this._urlFormulario = "html/formularios/usuarios_formatos.php";
	}
...
var vista = new UsuariosFormatosVista(this);
