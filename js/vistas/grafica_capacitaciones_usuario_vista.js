class GraficaCapacitacionesUsuarioVista extends CatalogoVista
{		
	constructor(ventana)
	{	
		super(ventana);
		this.presentador = new GraficaCapacitacionesUsuarioPresentador(this);
...
//	
	...
	set datos(porcentajesAreas)
	{
		am4core.ready(function() {
			...
			series.tooltipText = "{nombreCompleto} ({nombreUsuario}) : {valueY}% ({correctas}/{total})";
