class GraficaCapacitacionesTiempoUsuarioVista extends CatalogoVista
{		
	constructor(ventana)
	{	
		super(ventana);
		this.presentador = new GraficaCapacitacionesTiempoUsuarioPresentador(this);
...
//				$("#fechaFinalInputCriterio").val(fecha);
	...
	set datos(porcentajesAreas)
	{
		...
		am4core.ready(function() {
			...
			series.dataFields.valueY = "videosVistos";
			series.dataFields.categoryX = "nombreId";
			series.tooltipText = "{nombreCompleto} ({nombreUsuario}) : {valueY} ({tiempo})";
...
var vista = new GraficaCapacitacionesTiempoUsuarioVista(this);
