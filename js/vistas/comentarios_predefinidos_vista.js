class ComentariosPredefinidosVista extends CatalogoVista
{		
	constructor()
	{	
		super();
		this.presentador = new ComentariosPredefinidosPresentador(this);
		this._urlFormulario = "html/formularios/comentarios_predefinidos.php";
	}
...
//	}
	...
	crearColumnasGrid()
	{
		this.tabla.columnas = [
			...
			{longitud:200, 	titulo:"Comentario",   alias:"texto", alineacion:"I" }, 			
...
var vista = new ComentariosPredefinidosVista(this);
