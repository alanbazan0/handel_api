class GraficaCapacitacionesAvanceUsuarioVista extends CatalogoVista
{		
	constructor(ventana)
	{	
		super(ventana);
		this.presentador = new GraficaCapacitacionesAvanceUsuarioPresentador(this);
...
//				$("#fechaFinalInputCriterio").val(fecha);
	...
	set datos(porcentajesAreas)
	{
		am4core.ready(function() {
			...
			series.tooltipText = "{nombreCompleto} ({nombreUsuario}) : {valueY}% ({capacitacionesTerminadas}/{totalCapacitaciones})";
...
var vista = new GraficaCapacitacionesAvanceUsuarioVista(this);
