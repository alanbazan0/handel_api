class ReporteAvanceCapacitacionVista extends CatalogoVista
{		
	constructor(ventana)
	{	
		super(ventana);
		this.presentador = new ReporteAvanceCapacitacionPresentador(this);
...
//	
	...
	get criteriosSeleccion()
	{
		 ...
		 {				    
			...
			mostrar: $('#estatusCapacitacionCriterioSelect').val()
		 }
