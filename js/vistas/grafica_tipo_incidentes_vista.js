class GraficaTipoIncidentesVista extends CatalogoVista
{		
	constructor(ventana)
	{	
		super(ventana);
		this.presentador = new GraficaTipoIncidentesPresentador(this);
		this.consulto = false;
...
var vista = new GraficaTipoIncidentesVista(this);
