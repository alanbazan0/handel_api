class GraficaInspeccionesSedeVista extends CatalogoVista
{		
	constructor(ventana)
	{	
		super(ventana);
		this.presentador = new GraficaInspeccionesSedePresentador(this);
		this.consulto = false;
...
var vista = new GraficaInspeccionesSedeVista(this);
