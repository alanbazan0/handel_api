class GraficaRevisionProcesosDepartamentoVista extends CatalogoVista
{		
	constructor()
	{	
		super();
		this.presentador = new GraficaRevisionProcesosDepartamentoPresentador(this);
	}
	...
	set porcentajesEmpresas(porcentajesAreas)
	{
		am4core.ready(function() {
			...
			RevisionProcesosSeries.crear(chart,"nombreId","nombre");
...
var vista = new GraficaRevisionProcesosDepartamentoVista(this);	
