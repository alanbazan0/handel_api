class CertificacionesVista extends CatalogoVista
{		
	constructor()
	{	
		super();
		this.presentador = new CertificacionesPresentador(this);
		this._urlFormulario = "html/formularios/certificaciones.php";
	}
...
var vista = new CertificacionesVista(this);
