...
class ServiciosVista extends CatalogoVista
{
	constructor()
  {
      super();
      this.presentador = new ServiciosPresentador(this);
      this._urlFormulario = 'html/formularios/servicios.php';
  }
...
var vista = new ServiciosVista(this);
