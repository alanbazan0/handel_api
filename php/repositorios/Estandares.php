...
use php\repositorios\EstandaresRepositorio;
...
include '../repositorios/EstandaresRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new EstandaresRepositorio($conexion);
        switch ($accion)
        {           
            case 'insertar':               
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new Estandar());                   
