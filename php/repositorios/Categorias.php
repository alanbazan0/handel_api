...
use php\repositorios\CategoriasRepositorio;
...
include '../repositorios/CategoriasRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new CategoriasRepositorio($conexion);
        switch ($accion)
        {           
            case 'insertar':               
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new Categoria());                   
