...
use php\repositorios\ComentariosPredefinidosRepositorio;
...
include '../repositorios/ComentariosPredefinidosRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new ComentariosPredefinidosRepositorio($conexion);
        switch($accion)
        {
            case 'insertar':
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new ComentarioPredefinido());
