...
use php\repositorios\PaisesRepositorio;
...
include '../repositorios/PaisesRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new PaisesRepositorio($conexion);
        switch ($accion)
        {           
            case 'insertar':               
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new Pais());                   
