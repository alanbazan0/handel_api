    ...
    {            
        ...
        if($resultado->mensajeError=="")
        {
            ...
            $consulta = " INSERT INTO usuarios "
                        ...
                        . " permiso_sivah, "
                        . " permiso_10y7, "
                        . " departamento_id, permiso_cavih, perfil_id, recursos_humanos,numero_empleado ) "
                        . " VALUE(?,?,?,?,?,?,?,?,?,?,?,?,?,NOW(),NOW(),?,?,?,?,?,?,?,?,?) ";
