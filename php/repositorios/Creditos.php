...
use php\repositorios\CreditosRepositorio;
...
include '../repositorios/CreditosRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new CreditosRepositorio($conexion);
        switch ($accion)
        {           
            case 'insertar':               
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new Credito());                   
