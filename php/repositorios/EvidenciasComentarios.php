...
use php\repositorios\EvidenciasComentariosRepositorio;
...
include '../repositorios/EvidenciasComentariosRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new EvidenciasComentariosRepositorio($conexion);
        switch($accion)
        {
            case 'insertar':
                session_start();
                ...
                $modelo = $mapper->map($json, new EvidenciaComentario());
