...
use php\repositorios\PerfilesRepositorio;
...
include '../repositorios/PerfilesRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new PerfilesRepositorio($conexion);
        switch($accion)
        {
            case 'insertar':
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new Perfil());
