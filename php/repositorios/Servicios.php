...
use php\repositorios\ServiciosRepositorio;
...
include '../repositorios/ServiciosRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new ServiciosRepositorio($conexion);
        switch($accion)
        {
            case 'insertar':
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new Servicio());
