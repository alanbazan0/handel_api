...
use php\repositorios\TiposSocioComercialRepositorio;
...
include '../repositorios/TiposSocioComercialRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new TiposSocioComercialRepositorio($conexion);
        switch($accion)
        {
            case 'insertar':
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new TipoSocioComercial());
