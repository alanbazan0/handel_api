...
use php\repositorios\MensajesComentariosRepositorio;
...
include '../repositorios/MensajesComentariosRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new MensajesComentariosRepositorio($conexion);
        switch($accion)
        {
            case 'insertar':
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new MensajeComentario());
