...
use php\repositorios\RecomendacionesComentariosRepositorio;
...
include '../repositorios/RecomendacionesComentariosRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new RecomendacionesComentariosRepositorio($conexion);
        switch($accion)
        {
            case 'insertar':
                session_start();
                ...
                $modelo = $mapper->map($json, new RecomendacionComentario());
