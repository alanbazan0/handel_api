...
use php\repositorios\PuestosRepositorio;
...
include '../repositorios/PuestosRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new PuestosRepositorio($conexion);
        switch ($accion)
        {           
            case 'insertar':               
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new Puesto());                   
