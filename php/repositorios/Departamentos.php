...
use php\repositorios\DepartamentosRepositorio;
...
include '../repositorios/DepartamentosRepositorio.php';
...
try
{
    ...
    if($conexion)
    {
        ...
        $repositorio = new DepartamentosRepositorio($conexion);
        switch($accion)
        {
            case 'insertar':
                $json = json_decode(REQUEST('modelo'));
                $mapper = new JsonMapper();
                $modelo = $mapper->map($json, new Departamento());
