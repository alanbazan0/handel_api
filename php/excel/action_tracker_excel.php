...
try
{
    ...
    if($conexion)
    {
        ...
        if($resultado->correcto())
        {
            ...
            $hallazgos = array();
            $repositorio = new AuditoriasRepositorio($conexion);
            $resultado = $repositorio->consultarHallazgos($auditoria->id);
            if($resultado->correcto())
            {
                ...
                */
                ...
                //$xlsx->downloadAs("Action Tracker $empresa->nombre.xlsx");
                ...
                header("Content-Disposition: attachment; filename=Action Tracker $empresa->nombre.xls");
