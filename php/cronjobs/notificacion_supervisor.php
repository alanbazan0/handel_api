...
function getContenido(UsuariosRepositorio $usuariosRepositorio,UsuariosProcedimientosRepositorio $usuariosProcedimientosRepositorio,EvidenciasRepositorio $evidenciasRepositorio,$usuario,$dia)
{
    ...
    switch($dia)
    {
        ...
        case 14:
            ...
            $porcentajeDiferencia = number_format(abs($porcentajeDiferencia), 1, '.', '');
            if($porcentajeDiferencia>0)
                $porcentajeDiferencia = "<label style='font-weight:bold;color:#017000;'>$porcentajeDiferencia%</label> arriba";
            else
                $porcentajeDiferencia = "<label style='font-weight:bold;color:#ed220b;'>$porcentajeDiferencia%</label> abajo";
        ...
        case 21:
            ...
            $contenido .= "<br>".getUsuarios($usuario,$usuariosRepositorio,$evidenciasRepositorio,$usuariosProcedimientosRepositorio);
            $contenido .= "<br>".getCaricatura("https://api.apps-handel.com/images/caricatura/Little_Business_Girl-32.png");
            $contenido .= "<br>".getGracias();
        ...
        case 27:
            ...
            case 28:
                ...
                $contenido .= "<br>".getGracias();
                $contenido .= "<br>".getCaricatura("https://api.apps-handel.com/images/caricatura/Little_Business_Girl-78.png");
                $contenido .= "</div>
                            </div>";
